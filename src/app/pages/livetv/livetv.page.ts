...
export class LivetvPage implements OnInit {
  ...
  constructor(private iab: InAppBrowser,private httpClient: HttpClient,private appUpdate: AppUpdate ) {
    ...
    {channelName: 'ZEE TV', url: 'https://itpolly.iptv.digijadoo.net/live/zee_tv/chunks.m3u8', logo: 'http://zeelwebsite.s3.amazonaws.com/zeetele/wp-content/uploads/2017/09/zee_tv.jpg',alt:"ZEE TV" },
     ...
     { channelName: 'ZEE CINEMA', url: 'https://itpolly.iptv.digijadoo.net/live/zee_cinema/chunks.m3u8', logo: '',alt:"ZEE CINEMA" },
     { channelName: 'STAR GOLD', url: 'http://216.144.250.174/Star_G0ld_HD/tracks-v1a1/mono.m3u8', logo: '', alt:"STAR GOLD" },
     { channelName: 'SONY MAX HD', url: 'http://216.144.250.174/Sony_MaX_HD/playlist.m3u8', logo: '',alt:"SONY MAX HD" },
     { channelName: 'National Geographic', url: 'http://livecdnh1.tvanywhere.ae/hls/nat_geo/05.m3u8', logo: 'https://i.imgur.com/bUepAp5.png',alt:"National Geographic" },
     { channelName: 'National Geo Wild', url: 'http://livecdnh1.tvanywhere.ae/hls/nat_geo_wild/05.m3u8', logo: 'https://i.imgur.com/h0NNZ2U.png',alt:"Nat Geo Wild" },
