...
var NewsService = /** @class */ (function () {
    ...
    NewsService.prototype.getAllPosts = function (page) {
        ...
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?categories_exclude=262,16&page=' + page + "&per_page=20" + '&force=' + rand);
    };
    // get job posts
    ...
    NewsService.prototype.getAllLifeStylePosts = function (page) {
        ...
        var rand = Math.random();
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?tags=34,35,90,31,61,62,176,182,31,69,68,235,403,277,772,278,334&page=' + page + "&per_page=20" + '&force=' + rand);
    };
    /**
  ...
  */
    NewsService.prototype.getAllEducationPosts = function (page) {
        ...
        var rand = Math.random();
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?tags=33,767,718,412,471,717&page=' + page + "&per_page=20" + '&force=' + rand);
    };
    /**
    ...
    NewsService.prototype.getAllTechPosts = function (page) {
        var rand = Math.random();
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?tags=28,183,252,270,271,332,501&page=' + page + "&per_page=20" + '&force=' + rand);
    };
    /**
    ...
    NewsService.prototype.getAllInternationalPosts = function (page) {
        ...
        var rand = Math.random();
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?tags=32,409,440,410,368,376,406,374,441,380,371,430,367,229,12,140,658,479,226,401,663,118,121&page=' + page + "&per_page=20" + '&force=' + rand);
    };
    /**
    ...
    NewsService.prototype.getAllEconomyPosts = function (page) {
        ...
        var rand = Math.random();
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?tags=22,26,44,256,257,242,170,458,325&page=' + page + "&per_page=20" + '&force=' + rand);
    };
    /**
    ...
    NewsService.prototype.getAllCrimePosts = function (page) {
        ...
        var rand = Math.random();
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?tags=78,131,132,82,220,170,344,419,399,20,438,274,96,13,614,9&page=' + page + "&per_page=20" + '&force=' + rand);
    };
    NewsService.prototype.getAllCulturePosts = function (page) {
        // 390=কারেন্ট স্টোরিজ,259=আলাপন
        var rand = Math.random();
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?tags=267,207,206,111,203,54,259,390&page=' + page + "&per_page=20" + '&force=' + rand);
    };
    NewsService.prototype.getAllVividPosts = function (page) {
        //391=টপ%20স্টোরিজ,225,342,202,660,353=বিশ্ব
        var rand = Math.random();
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?tags=164,178,92,165,230,233,114,67,36,180,154,194,209,225,342,202,660,353,391&page=' + page + "&per_page=20" + '&force=' + rand);
    };
    NewsService.prototype.getAllBusinessPosts = function (page) {
        var rand = Math.random();
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?tags=264,274,86,87,26,44,263,257,400,242,670&page=' + page + "&per_page=20" + '&force=' + rand);
    };
    ...
    NewsService.prototype.getAllPoliticsPosts = function (page) {
        ...
        var rand = Math.random();
        return this.http.get(_globalSettings__WEBPACK_IMPORTED_MODULE_3__["API_SLUG"] + 'posts?tags=442,199,134,23,149,186&page=' + page + "&per_page=20" + '&force=' + rand);
    };
